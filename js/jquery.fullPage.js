		...
		*/
		function addVerticalNavigation(){
			...
			for (var i = 0; i < $('.fp-section').length; i++) {
				...
				// 修改内容，对象中添加一个pname，再修改样式
				if(i==0){
					var li = '<li><a class="nav-bar" href="#' + link + '"><span style="line-height:32px;">'+options.pname[i]+'</span></a>';
				}
				else if(i==5){
					var li = '<li><a class="nav-bar" href="#' + link + '"><span style="padding:14px 0 0 0;display:inline-block;text-align: center;">'+options.pname[i]+'</span></a></li><li><a href="#' + link + '"><span class="QR_C" style="text-align: center;">二维码</span></a>';
				}
				else{
					var li = '<li><a class="nav-bar" href="#' + link + '"><span>'+options.pname[i]+'</span></a>';
				}
